...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '1qC0-gqb5-BBsucjXHWJUsqUi1e3BMjqc-4ICTOfxQQ4', //** CHANGE !!!
    dataRage        : 'Data!A2:G',                                    //** CHANGE !!!
    idRange         : 'Data!A2:A',                                    //** CHANGE !!!
    lastCol         : 'G',                                            //** CHANGE !!!
    insertRange     : 'Data!A1:G1',                                   //** CHANGE !!!
    sheetID         : '1884770277'                                             //** CHANGE !!! Ref:https://developers.google.com/sheets/api/guides/concepts#sheet_id
  };
  return varArray;
}
